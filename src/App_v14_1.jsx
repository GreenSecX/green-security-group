...
// ── AFFILIATE LINKS — replace placeholder hrefs with real affiliate links ────
const AFFILIATES = [
  {
    name: "Bitwarden",
    icon: "🔑",
    category: "Password Manager",
    desc: "Free, open-source password manager trusted by millions. The #1 recommendation for every SMB.",
    badge: "Free Plan Available",
    badgeColor: "#22c55e",
    href: "https://bitwarden.com", // REPLACE WITH YOUR AFFILIATE LINK
  },
  {
    name: "1Password",
    icon: "🗝️",
    category: "Password Manager",
    desc: "Best-in-class password manager for teams. Easy onboarding, powerful admin controls.",
  ...
  },
  {
    ...
    desc: "Zero-trust network access built for small businesses. Secure remote work in minutes.",
    badge: "SMB Favourite",
    badgeColor: "#4687FF",
    href: "https://nordlayer.com", // REPLACE WITH YOUR AFFILIATE LINK
  },
  {
    name: "NordVPN",
    icon: "🔒",
    category: "Personal VPN",
    desc: "Protect staff on public Wi-Fi and remote connections. Simple to deploy across your team.",
    badge: "Staff Use",
    badgeColor: "#4687FF",
    href: "https://nordvpn.com", // REPLACE WITH YOUR AFFILIATE LINK
  },
  {
    name: "Backblaze",
    icon: "☁️",
    category: "Cloud Backup",
    desc: "Simple, affordable cloud backup with ransomware protection and immutable storage.",
    badge: "Recommended Backup",
    badgeColor: "#e05a1e",
    href: "https://backblaze.com", // REPLACE WITH YOUR AFFILIATE LINK
  },
  {
    name: "Acronis",
    icon: "💾",
    category: "Business Backup & DR",
    desc: "Enterprise-grade backup and disaster recovery for businesses that can't afford downtime.",
    badge: "Enterprise Grade",
    badgeColor: "#8b5cf6",
    href: "https://acronis.com", // REPLACE WITH YOUR AFFILIATE LINK
  },
  {
    name: "Malwarebytes",
    icon: "🦠",
    category: "Endpoint Security",
    desc: "Real-time malware and ransomware protection for all business devices. Easy central management.",
    badge: "Business Plan",
    badgeColor: "#ef4444",
    href: "https://malwarebytes.com", // REPLACE WITH YOUR AFFILIATE LINK
  },
];
...
const css = `
  * { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  .btn-primary { padding: 13px 28px; border-radius: 7px; background: var(--green); color: #000; font-weight: 700; font-size: 14px; border: none; cursor: pointer; margin-bottom: 12px; }
  .btn-primary:hover { background: var(--green2); color: #fff; }

  /* HERO QUICK LINKS */
  .hero-quick-links { display: flex; gap: 10px; flex-wrap: wrap; justify-content: center; margin-bottom: 40px; }
  .hero-quick-link { padding: 7px 16px; border-radius: 100px; font-size: 11px; font-weight: 600; border: 1px solid var(--border2); color: var(--muted); background: var(--surface); text-decoration: none; transition: all 0.15s; }
  .hero-quick-link:hover { border-color: var(--green); color: var(--green); background: rgba(34,197,94,0.06); }
  .hero-quick-link.toolkit { border-color: rgba(99,179,237,0.3); color: #63b3ed; background: rgba(99,179,237,0.06); }
  .hero-quick-link.toolkit:hover { border-color: #63b3ed; background: rgba(99,179,237,0.12); }
  .hero-quick-link.report { border-color: rgba(34,197,94,0.3); color: var(--green); background: rgba(34,197,94,0.06); }
  .hero-quick-link.report:hover { border-color: var(--green); background: rgba(34,197,94,0.12); }
  ...
  .certs { display: flex; gap: 5px; flex-wrap: wrap; justify-content: center; max-width: 600px; margin-bottom: 32px; }
  ...
  /* AFFILIATE SECTION */
  .affiliate-section { width: 100%; max-width: 760px; margin: 0 auto; padding: 48px 20px 60px; }
  .affiliate-section-header { text-align: center; margin-bottom: 28px; }
  .affiliate-section-eyebrow { font-size: 9px; color: var(--green); text-transform: uppercase; letter-spacing: 0.12em; margin-bottom: 8px; }
  .affiliate-section-title { font-size: 22px; font-weight: 800; color: var(--text); margin-bottom: 8px; }
  .affiliate-section-sub { font-size: 12px; color: var(--muted); line-height: 1.7; max-width: 420px; margin: 0 auto; }
  .affiliate-grid { display: grid; grid-template-columns: repeat(auto-fit, minmax(200px, 1fr)); gap: 10px; }
  .affiliate-card { background: var(--surface); border: 1px solid var(--border); border-radius: 10px; padding: 16px; text-decoration: none; color: var(--text); transition: all 0.15s; display: flex; flex-direction: column; gap: 8px; }
  .affiliate-card:hover { border-color: var(--border2); background: var(--surf2); transform: translateY(-2px); box-shadow: 0 4px 20px rgba(0,0,0,0.3); }
  .affiliate-card-top { display: flex; align-items: center; gap: 10px; }
  .affiliate-card-icon { font-size: 22px; flex-shrink: 0; }
  .affiliate-card-name { font-size: 14px; font-weight: 800; }
  .affiliate-card-cat { font-size: 9px; color: var(--muted); text-transform: uppercase; letter-spacing: 0.06em; margin-top: 1px; }
  .affiliate-card-desc { font-size: 11px; color: var(--muted); line-height: 1.6; flex: 1; }
  .affiliate-card-badge { display: inline-block; padding: 2px 9px; border-radius: 100px; font-size: 9px; font-weight: 700; text-transform: uppercase; letter-spacing: 0.06em; align-self: flex-start; }
  .affiliate-disclaimer { text-align: center; font-size: 9px; color: var(--dim); margin-top: 16px; line-height: 1.6; }
    ...
    <div>
      ...
      {phase === "hero" && (
        ...
        <div className="hero">
          ...
          {/* QUICK LINKS — skip straight to toolkit or report */}
          <div className="hero-quick-links">
            <a
              className="hero-quick-link toolkit"
            ...
            <a
              className="hero-quick-link report"
        ...
        <div className="affiliate-section">
          <div className="affiliate-section-header">
            <div className="affiliate-section-eyebrow">✓ CISSP-Vetted · Personally Recommended</div>
            <div className="affiliate-section-title">Recommended Security Tools</div>
            <div className="affiliate-section-sub">
              Every tool below is personally vetted and recommended for small businesses. These are the tools I point clients to when they ask what to use.
            </div>
          </div>
            ...
            {AFFILIATES.map(a => (
              ...
              >
                <div className="affiliate-card-top">
                  <span className="affiliate-card-icon">{a.icon}</span>
                  <div>
                    <div className="affiliate-card-name">{a.name}</div>
                    <div className="affiliate-card-cat">{a.category}</div>
                  </div>
                </div>
                <div className="affiliate-card-desc">{a.desc}</div>
                <span
                  className="affiliate-card-badge"
                  style={{ background: a.badgeColor + "22", color: a.badgeColor }}
                >
                  {a.badge}
                </span>
              </a>
          ...
          <div className="affiliate-disclaimer">
            * Some links are affiliate links. All recommendations are based on professional experience — not compensation.
          </div>
        </div>
        </>
      )}

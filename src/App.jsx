...
export default function App() {
  ...
  // Check for Gumroad redirect verification on load
  useEffect(() => {
        ...
        <div className="results">
          ...
          {verified && (
            <div className="verified-banner">
              ...
              <div>
                <div style={{fontSize:13,fontWeight:600,color:"var(--green)"}}>Purchase Verified — Thank You!</div>
                <div style={{fontSize:12,color:"var(--muted)"}}>Your Professional Report is ready to download below.</div>
              </div>
            </div>
          )}
          ...
          <div className="report-cards">
            ...
            <div className="report-card rc-paid">
              <div className="rc-badge" style={{color:"var(--green)"}}>
                {verified ? "✅ Purchase Verified — Ready to Download" : "⚡ Professional · Fully Personalized"}
              </div>
              <div className="rc-title">Professional Report</div>
              <div className="rc-desc">A 15-page report with step-by-step remediation for every finding, a custom 90-day roadmap, and policy recommendations — personalized to your answers.</div>
              <div className="rc-includes">
                {["Executive summary for your business","Every finding with step-by-step fix","Prioritized remediation plan","Custom 90-day roadmap","Policy recommendations","Signed by Paul Green, CISSP"].map(i=>(
              ...
              {verified ? (
                <button className="rc-btn rc-btn-paid" onClick={()=>downloadReport(true)}>
                  ⬇ Download Your Professional Report
                </button>
              ) : (
                <>
                  <button className="rc-btn rc-btn-paid"
                    onClick={()=>window.open("https://greensecure.gumroad.com/l/jtrkdq","_blank")}>
                    Purchase on Gumroad — $97 →
                  </button>
                  <div style={{textAlign:"center",marginTop:10,fontSize:11,color:"var(--dim)",fontFamily:"var(--mono)",lineHeight:1.6}}>
                    After purchase, Gumroad will redirect you back here<br/>and your report will be ready to download instantly.
                  </div>
                </>
              )}
            </div>

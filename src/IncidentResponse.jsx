...
const SCENARIOS = [
  ...
  },
  {
    ...
    law: "PIPEDA \u2014 the duty is to assess whether there is a \u201creal risk of significant harm,\u201d weighing the sensitivity of the data and the probability of misuse. Where the assessment finds that risk, the firm reports to the OPC and notifies affected individuals as soon as feasible. Separately, every breach of security safeguards is recorded and kept 24 months, regardless of the finding. (Educational, not legal advice; a real breach decision is made with qualified counsel.)",
    ...
    options: [
      ...
      { k:"C", correct:true, label:"Run the harm assessment \u2014 high-sensitivity SINs, bank data, and confirmed unauthorized access all point toward a real risk \u2014 and where that assessment holds, report to the OPC, notify affected individuals as soon as feasible, record the breach for 24 months, and confirm the call with counsel.", verdict:"Correct", why:"The only path that treats the privacy obligation as the separate track it is: run the assessment, meet the reporting duty where the risk is found, and keep the 24-month record regardless. It doesn\u2019t skip the assessment, and it doesn\u2019t guess at the law alone \u2014 counsel confirms the call." },

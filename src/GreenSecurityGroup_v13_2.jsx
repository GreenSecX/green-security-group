...
<div style="margin-top:24px;padding:22px 28px;background:#0b1628;border-radius:10px;text-align:center;">
  ...
  <div style="font-size:12px;color:#94a3b8;max-width:440px;margin:0 auto 12px;line-height:1.65;">Policy templates, risk register, 90-day roadmap, and security guide — everything you need to implement these recommendations. From $47.</div>
  <a href="https://greensecure.gumroad.com/l/fmxotn" style="display:inline-block;padding:11px 28px;background:#22c55e;color:#000;border-radius:7px;font-weight:700;text-decoration:none;font-size:13px;margin-bottom:8px;">Get the Security Toolkit →</a>
  <div style="font-size:11px;color:#475569;">greensecure.gumroad.com · Instant download · $47 Solo / $97 Team / $197 Consultant</div>
</div>
          ...
          <div className="report-grid">
            ...
            <div className="report-card" style={{ background: "rgba(99,179,237,0.06)", border: "1px solid rgba(99,179,237,0.2)" }}>
              ...
              <div style={{ marginBottom: 12 }}>
                <span className="report-price" style={{ color: "#63b3ed" }}>$47</span>
                <span style={{ fontSize: 12, color: "var(--muted)", marginLeft: 8 }}>Solo · $97 Team · $197 Consultant</span>
              </div>
              <a
